...
const RunningEllipsisIcon = ({ className }: { className?: string }) => (
  <svg
    viewBox="0 0 24 24"
    aria-hidden="true"
  ...
  >
    ...
    />
    <circle cx="18" cy="12" r="1.5" className="animate-pulse" />
  </svg>
);
...
export const ChainOfThoughtImage = memo(
  ({ className, children, caption, ...props }: ChainOfThoughtImageProps) => (
    <div className={cn("mt-2 space-y-2", className)} {...props}>
      <div className="relative flex max-h-[22rem] items-center justify-center overflow-hidden rounded-lg bg-muted/40 p-3">
        {children}
      </div>
