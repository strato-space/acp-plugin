...
export function ChatInput() {
  ...
  return (
    <div className="sticky bottom-0 flex w-full flex-col gap-4 overflow-visible rounded-t-3xl bg-background pb-4 px-4">
      <div
        ref={dropZoneRef}
            ...
            <div className="flex items-center gap-2 px-3 pb-1.5">
              {selectedAgent && (
                ...
                >
                  ...
                  <span className="font-medium px-2 py-0.5 rounded-full border border-border/50 bg-muted/20">
                    {selectedAgent.name}
                  </span>
                </button>
              )}
            ...
            <div className="px-3 pb-2 space-y-1.5">
              {queuedMessages.map((item) => {
                ...
                return (
                  <div
                    key={item.id}
                    className="flex items-center justify-between gap-2 rounded-xl border border-border/60 bg-muted/20 px-2.5 py-1.5"
                    title={item.text}
                  >
